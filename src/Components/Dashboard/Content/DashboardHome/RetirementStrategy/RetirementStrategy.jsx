...
const RetirementStrategy = () => {
    ...
    return (
        <div className=' md:h-screen   w-full'>
            <div className='flex flex-col justify-center px-12 md:mt-10  '>
                ...
                <div className='flex flex-col gap-y-3 bg-[#FAFAFA] p-2'>
                    ...
                    <div >
                        <button className='mb-3 w-full text-center mx-auto gap-1 bg-[#4935FF] text-white px-5 py-2 font-semibold rounded-lg text-sm'>Update
                        </button>
                    </div>
                    <div className='hidden text-center mx-auto md:flex items-center'>
                ...
                {/* Housing Advance */}
                <div className='hidden md:block mt-5 border-l-2 border-[#4935FF] pl-4'>
                    <div className='mb-2'>
